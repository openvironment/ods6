...
golem::fill_desc(
  ...
  repo_url = "https://github.com/curso-r/ods6" # The URL of the GitHub Repo (optional)
)
...
golem::use_favicon("https://discourse.curso-r.com/uploads/default/optimized/1X/df789d4bc19428ffeeb6ce337183b7107548f655_2_32x32.png") # path = "path/to/ico". Can be an online file.
