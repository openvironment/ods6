...
Para facilitar a utilização dos dados, juntamos todas as bases em uma única, chamada de `base_agregada`.
...
- [versão CSV](https://github.com/openvironment/ods6/raw/main/data-raw/base_agregada.csv)
- [versão Excel](https://github.com/openvironment/ods6/raw/main/data-raw/base_agregada.xlsx)


## Base de indicadores

Por fim, criamos a base final utilizada na construção do dashboard. Essa base é constituída de indicadores construídas a partir da base agregada. A definição de cada indicador está apresentada no próximo capítulo.
