...
A base completa foi construída por meio da junção das bases descritas nas seções anteriores.

O script em R utilizado para a junção das bases se encontra [aqui](https://github.com/openvironment/ods6/blob/main/data-raw/base_completa.R).

Abaixo disponibilizamos links para o download direto da base completa:

- [versão CSV](https://github.com/openvironment/ods6/raw/main/data-raw/base_completa.csv)
- [versão Excel](https://github.com/openvironment/ods6/raw/main/data-raw/base_completa.xlsx)
